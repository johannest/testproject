package org.vaadin.testproject.client.samples;
...
import org.vaadin.testproject.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@org.vaadin.testproject.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
