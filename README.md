...
- testproject-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- testproject-ui: main application module, development time
- testproject-production: module that produces a production mode WAR for deployment
